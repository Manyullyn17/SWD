...
namespace satellite
{
	public class Satellite : GraphicObject
	{
		...
		public override void PaintVisible(Graphics g)
		{
            ...
            g.FillEllipse(foregBrush, m_Pos.XI-m_Radius, m_Pos.YI-m_Radius, 2*m_Radius, 2*m_Radius );
		}

		public override void PaintInVisible(Graphics g)
		{
            g.FillEllipse(backgBrush, m_Pos.XI-m_Radius, m_Pos.YI-m_Radius, 2 * m_Radius, 2 * m_Radius);
        }
    }
}
